...
<body>
	...
	<form method="post" action="#">
		<div data-mdb-input-init class="form-outline mb-4">
			<label class="form-label fw-bold" for="form3Example3"><b>Class
		...
		<br>
		<div data-mdb-input-init class="form-outline mb-4">
			<label class="form-label" for="form3Example3"><b>Subject
					Name</b></label> <input type="text" id="classname" name="classname"
				class="form-control" />
		</div>
		<br>
		<div>
    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="adminsubject.jsp"> <i
							class="pe-7s-study"></i>
							<p>Subjects</p>
					</a></li>
		...
		<div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<P style="font-size: 20px;">SUBJECTS</P>
					<div class="row">
						<div class="col-md-8">
							<div class="card">
