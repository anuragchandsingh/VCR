...
<div class="wrapper">
    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li class="active"><a href="admindashboard.jsp"> <i class="pe-7s-graph"></i>
							<p>Admin Dashboard</p>
					</a></li>
      ...
      <nav class="navbar navbar-default navbar-fixed">
        ...
        <div class="content">
           ...
           <P style="font-size: 20px;">ADMIN DASHBOARD</P>
                <div class="row">
                    <div class="col-md-3" >
                        <div class="card" style="background-color:lightcoral; color: white;">
                            <div class="header" >
                               <p style="font-size: 20px;">Uploaded Materials</p>
                            </div>
                            <div class="content">
                               <p>Total No - 0</p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="background-color:mediumslateblue; color: white;">
                    ...
                    <div class="col-md-3">
                        <div class="card" style="background-color:yellowgreen; color: white;">
                            ...
                            <div class="header" >
                               <p style="font-size: 20px;">Registered Users</p>
                            </div>
                            <div class="content">
                                 <p>Total No - 0</p>
                            </div>
