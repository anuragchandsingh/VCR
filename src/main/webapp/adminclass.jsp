    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="adminclass.jsp"> <i class="pe-7s-cash"></i>
							<p>Classes</p>
					</a></li>
					<li><a href="adminsubject.jsp"> <i
							class="pe-7s-study"></i>
							<p>Subjects</p>
					</a></li>
									...
									<table class="table table-hover table-striped">
										...
										<tbody>
											<tr>
												...
												<td>
												<a href="#" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger btn-fill btn-xs">
								...
								<div class="content">
									<form method="post" action="#">
										<div data-mdb-input-init class="form-outline mb-4">
											<label class="form-label" for="form3Example3">,<b>Class Name</b></label>
											 <input type="text" id="classname" name="classname" class="form-control" />
										</div>
										<br>
										<div>
										<button type="submit" class="btn btn-primary btn-fill pull-right">&#10010; Add Class</button>
										</div>
